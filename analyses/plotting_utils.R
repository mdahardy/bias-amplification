    ...
    raw_data %>%
      mutate(
        condition = case_when(
          ...
          condition == 'asocial_motivated' ~ 'Asocial motivated',
          condition == 'social_motivated' ~ 'Social motivated',
...
get_plot_colors = function(experiment_num){
  global_colors = c(
    ...
    "Asocial motivated" =  "#fdae61",
    "Social control" ='#abd9e9',
    "Social motivated" = "#d7191c", 
    "Social resampling" = '#2c7bb6')
  condition_colors = c(
    global_colors['Asocial motivated'],
    global_colors['Social motivated']
  )
  if (experiment_num == 1){
    condition_colors = c(
      condition_colors,
